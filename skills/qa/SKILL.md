...
Author QA plans, observations, and evaluator explanations in the user's current conversation language, following the workflow language contract while preserving machine assertion fields.
