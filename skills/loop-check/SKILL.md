...
Author manual findings and explanations in the user's current conversation language, following the workflow language contract; never rewrite deterministic analyzer output.
