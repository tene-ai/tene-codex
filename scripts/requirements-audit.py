...
COMMANDS={
 ...
 "playwright":[["npx","playwright","test","tests/e2e/reference-web.spec.ts"]], "release":[["./scripts/release-smoke.sh"]], "portable":[["./scripts/release-smoke.sh"]], "app-compact":[["go","test","./internal/app","-run","TestCLICompactBoundsJournalAndDoctorDetectsArchiveTamper"]], "schema":[["@json-schemas"]], "plugin":[["@plugin"]]}
